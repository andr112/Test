      ...
      children: [
        new SizedBox(
          ...
          child: ListView(
            ...
            children: <Widget>[
              new FlutterLogo(textColor: Colors.pink, size: 100),
              new FlutterLogo(textColor: Colors.teal, size: 100),
              new FlutterLogo(textColor: Colors.brown, size: 100),
              new FlutterLogo(textColor: Colors.lightBlue, size: 100),
              new FlutterLogo(textColor: Colors.green, size: 100),
              new FlutterLogo(textColor: Colors.pink, size: 100),
              new FlutterLogo(textColor: Colors.teal, size: 100),
              new FlutterLogo(textColor: Colors.brown, size: 100),
              new FlutterLogo(textColor: Colors.lightBlue, size: 100),
